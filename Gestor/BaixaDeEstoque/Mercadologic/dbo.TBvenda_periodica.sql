...
if object_id('dbo.TBvenda_periodica') is null begin
  create table dbo.TBvenda_periodica (
    ...
    DFvenda_diaria_atualizada bit not null default 0
  )
  ...
  create index IX__TBvenda_periodica__DFvenda_diaria_atualizada
      on dbo.TBvenda_periodica (DFvenda_diaria_atualizada)
end
