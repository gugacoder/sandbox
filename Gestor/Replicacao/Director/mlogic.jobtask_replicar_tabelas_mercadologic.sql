--
-- PROCEDURE mlogic.jobtask_replicar_tabelas_mercadologic
--
drop procedure if exists mlogic.jobtask_replicar_tabelas_mercadologic
go
create procedure mlogic.jobtask_replicar_tabelas_mercadologic
  @command varchar(10),
...
begin
  ...
  if @command = 'init' begin
    ...
    begin try
      exec mlogic.replicar_tabelas_mercadologic @cod_empresa
    end try begin catch
