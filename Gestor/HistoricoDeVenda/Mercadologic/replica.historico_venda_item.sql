...
-- 
-- Porém, neste caso específico da tabela `replica.historico_venda_item`
-- a criação da tabela é antecipada para permitir a construção dos scripts
-- de baixa automática de estoque dependentes desta tabela.
-- 
